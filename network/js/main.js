...
function nodeActive(a) {
    ...
    if (f.attributes) {
        ...
        var name_attribute = false;
        console.log(config);
        if (config.informationPanel.imageAttribute) {
            image_attribute = config.informationPanel.imageAttribute;
        }

        if (config.informationPanel.nameAttribute) {
            name_attribute = config.informationPanel.nameAttribute;
        }
        e = [];
        temp_array = [];
        g = 0;
        ...
        if (image_attribute) {
            ...
            if(f.attributes[image_attribute]){
                $GP.info_name.html("<div><img src=" + f.attributes[image_attribute] + " style=\"vertical-align:middle\" /> <span onmouseover=\"sigInst._core.plotter.drawHoverNode(sigInst._core.graph.nodesIndex['" + b.id + '\'])" onmouseout="sigInst.refresh()">' + b.label + "</span></div>");
            }
            else{
                $GP.info_name.html("<div><img src=" + 'images/avatar_default.png' + " style=\"vertical-align:middle\" width='20'/> <span onmouseover=\"sigInst._core.plotter.drawHoverNode(sigInst._core.graph.nodesIndex['" + b.id + '\'])" onmouseout="sigInst.refresh()">' + b.label + "</span></div>");
