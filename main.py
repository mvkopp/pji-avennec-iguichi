...
def main_by_author(author_name):
    ...
    CRISTAL_members = scrape_scientist.recover_all_cristal_members_with_infos()

    print('\n----'+len(author_name)*'-'+'----\n'+'*** '+author_name+' ***\n'+'----'+len(author_name)*'-'+'----')
    
    # DBLP
    print("\n--------\n| DBLP |\n--------\n")
    publications_from_dblp = dblp_api.get_articles_by_author(author_name,CRISTAL_members)
    ...
    # Crossref
    print("\n------------\n| Crossref |\n------------\n")
    publications_from_crossref = crossref_api.get_articles_by_author(author_name,CRISTAL_members)
...
def main():
    ...
    CRISTAL_non_permanent_members = scrape_scientist.recover_all_cristal_members()['permanent']

    CRISTAL_members = scrape_scientist.recover_all_cristal_members_with_infos()

    for member_name in CRISTAL_members :
        ...
        # DBLP
        print("\n--------\n| DBLP |\n--------\n")
        publications_from_dblp = dblp_api.get_articles_by_author(member_name,CRISTAL_members)
        ...
        # Crossref
        print("\n------------\n| Crossref |\n------------\n")
        publications_from_crossref = crossref_api.get_articles_by_author(member_name,CRISTAL_members)
...
if __name__ == "__main__": # execute only if run as a script
    ...
    #main_by_author('Laetitia Jourdan')
    main()
